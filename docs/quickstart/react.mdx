...
> **Not using React?** For Vue, Svelte, Node.js, or vanilla JavaScript, use the [`hyperstack-typescript`](/sdks/typescript/overview#typescript-core-sdk-hyperstack-typescript) package instead.
...
- [Define your own stack](/guides/defining-stacks) - Create custom data streams
