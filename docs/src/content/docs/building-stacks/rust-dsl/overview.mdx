...
The macros transform your Rust code into a JSON-based AST (Abstract Syntax Tree), which Hyperstack compiles into optimized bytecode for real-time execution.
...
pub mod my_stream {
    ...
    pub struct Token {
        ...
        #[map(TokenAccount::balance, strategy = LastWrite)]
        pub balance: u64,
