...
## How Definitions Become Data Streams

When you build your Rust project containing a Hyperstack definition, the macros perform several steps:
...
3.  **Bytecode Compilation**: When you deploy your stack (`hs up`), Hyperstack Cloud compiles this AST into optimized bytecode.
4.  **Execution**: The Hyperstack VM executes this bytecode against the Solana transaction firehose, updating your entity state and streaming diffs to your clients.
