...
:::tip[New to coding?]
If you haven't set up an AI coding tool yet, start with our [Setup Guide](/getting-started/setup-tools/) which walks you through installing Cursor, Claude Code, or similar tools from scratch.
:::
