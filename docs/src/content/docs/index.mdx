...
✔ Stack pushed (v1)
✔ Build completed
🚀 Deployed: wss://my-stack.stack.usehyperstack.com
```
...
<CardGrid>
  <Card title="Installation" icon="laptop">
    ...
    [Get started →](/using-stacks/installation/)

  </Card>
  <Card title="Your First Stack" icon="rocket">
    Build and deploy a complete stack in 15 minutes.

    [Start building →](/building-stacks/your-first-stack/)
  ...
  <Card title="Stack Macros" icon="document">
    Full reference for mapping and aggregation macros.

    [View reference →](/building-stacks/macros/)
