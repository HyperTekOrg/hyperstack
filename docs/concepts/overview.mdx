...
#[entity(name = "Token")]
pub struct Token {
    #[map_instruction(Create::mint, primary_key)]
    pub mint: String,
...
A **spec** is a declarative definition of your data model. Written in Rust using macros:

```rust
#[stream_spec(idl = "parser/idl.json")]
pub mod my_spec {
    #[entity(name = "Token")]
    pub struct Token {
...
| `#[map_instruction]` | Instruction arg/account | `#[map_instruction(Create::mint)]` |
...
- [React Quickstart](/quickstart/react) - Build your first app
- [Stack API](/concepts/stack-api) - Client-side API reference
- [Spec DSL](/spec-dsl/macros) - Full macro reference
