...
pub use arete_interpreter as interpreter;

// Re-export macros
#[cfg(feature = "macros")]
pub use arete_macros as macros;

// Re-export server components
#[cfg(feature = "server")]
pub use arete_server as server;
...
pub mod runtime {
    ...
    pub mod serde_helpers {
        ...
        ///
        /// Usage: `#[serde(with = "arete::runtime::serde_helpers::big_array")]`
        pub mod big_array {
            use serde::{
...
pub mod prelude {
    ...
    // Re-export server components
    #[cfg(feature = "server")]
    pub use arete_server::{bus::BusManager, config::ServerConfig, projector::Projector};

    // Re-export SDK client
    #[cfg(feature = "sdk")]
    pub use arete_sdk::Arete;
}
