//! Hyperstack Reference Authentication Server
//!
//! This is a reference implementation of an authentication server for Hyperstack.
//! It provides:
...
async fn main() -> anyhow::Result<()> {
    ...
    info!("Starting Hyperstack Auth Server...");
